    ...
    <section id="how-it-works" className="py-24 bg-meetable-light">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-meetable-teal font-bold tracking-wider uppercase text-sm mb-3">Effortless Socializing</h2>
        ...
        <div className="flex overflow-x-auto md:grid md:grid-cols-3 lg:grid-cols-5 gap-6 pb-8 hide-scrollbar snap-x snap-mandatory px-4 md:px-0 -mx-4 md:mx-0">
            {steps.map((step, index) => (
                <div 
                    key={step.id} 
                    className="snap-center shrink-0 w-[85vw] sm:w-[350px] md:w-auto relative group rounded-3xl overflow-hidden h-[450px] shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-gray-900"
                >
                    {/* Background Image */}
                    ...
                    <div className="absolute inset-0 p-8 flex flex-col justify-between text-white z-10">
                        ...
                        <div className="flex justify-start">
                            <div className={`w-14 h-14 rounded-full ${step.color} flex items-center justify-center shadow-lg border-2 border-white/20 transform group-hover:rotate-12 transition-transform`}>
                        ...
                        <div className="transform translate-y-2 group-hover:translate-y-0 transition-transform">
                            ...
                            <h4 className="font-serif text-2xl font-bold mb-3 leading-tight">{step.title}</h4>
